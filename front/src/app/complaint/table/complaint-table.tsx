...
export default function ComplaintTable() {
    ...
    const handleEditClick = (complaint: Complaint) => {
        ...
        form.reset({
            ...
            date: new Date(complaint.date), // Ensure the date is parsed correctly
    ...
    name="date"
    render={({ field }) => {
        // Debugging: Log the current field value
        console.log("Current Date Field Value:", field.value);
            ...
            <FormItem>
                ...
                <Popover>
                    ...
                    <PopoverContent className="w-auto p-0" align="start">
                        <Calendar
                            mode="single"
                            selected={field.value ? new Date(field.value) : undefined}                            onSelect={(date) => {
                                console.log("Selected Date:", date);
                                if (date) {
                                    field.onChange(date);
                                    console.log("Updated Form State:", form.getValues());
                                }
                            }}
